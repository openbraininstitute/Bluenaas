...
from app.domains.morphology import SynapseSeries, SynapseConfig, SynapsesPlacementConfig
...
def run_unified_simulation(
    ...
    *,
    ...
    try:
        ...
        expanded_configs = expand_simulation_config(config, synaptome_details, model)
