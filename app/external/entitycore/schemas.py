...
#   timestamp: 2025-06-27T17:26:44+00:00
...
class CircuitBuildCategory(Enum):
    computational_model = "computational_model"
    em_reconstruction = "em_reconstruction"


class CircuitScale(Enum):
    single = "single"
    pair = "pair"
    small = "small"
...
class SimulationExecutionUpdate(BaseModel):
    ...
    generated_ids: Optional[List[UUID]] = Field(None, title="Generated Ids")
    status: Optional[SimulationExecutionStatus] = None
...
class SimulationGenerationCreate(BaseModel):
    ...
    start_time: Optional[datetime] = Field(None, title="Start Time")
    end_time: Optional[datetime] = Field(None, title="End Time")
    used_ids: Optional[List[UUID]] = Field([], title="Used Ids")
    generated_ids: Optional[List[UUID]] = Field([], title="Generated Ids")
...
class CircuitCreate(BaseModel):
    ...
    brain_region_id: UUID = Field(..., title="Brain Region Id")
    subject_id: UUID = Field(..., title="Subject Id")
    experiment_date: Optional[datetime] = Field(None, title="Experiment Date")
    contact_id: Optional[UUID] = Field(None, title="Contact Id")
    atlas_id: Optional[UUID] = Field(None, title="Atlas Id")
    name: str = Field(..., title="Name")
    description: str = Field(..., title="Description")
    ...
    number_connections: Optional[int] = Field(..., title="Number Connections")
    scale: CircuitScale
    build_category: CircuitBuildCategory
    root_circuit_id: Optional[UUID] = Field(None, title="Root Circuit Id")
