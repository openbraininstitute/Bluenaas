...
generate-entitycore-schemas:
	curl -o openapi.json https://staging.openbraininstitute.org/api/entitycore/openapi.json & poetry run datamodel-codegen --input openapi.json --input-file-type openapi --output bluenaas/external/entitycore/schemas.py